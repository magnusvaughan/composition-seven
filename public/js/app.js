...
var state = {
  ...
  bpm: 120,
  delay: false,
  synth: new tone__WEBPACK_IMPORTED_MODULE_0___default.a.PolySynth(6, tone__WEBPACK_IMPORTED_MODULE_0___default.a.Synth, {
    "portamento": 0,
    "oscillator": {
      "type": "square4"
    },
  ...
  }).toMaster() //todo - Load state from localStorage
...
function playSequence() {
  ...
  var seq = new tone__WEBPACK_IMPORTED_MODULE_0___default.a.Sequence(function (time, column) {
    for (var i = 0; i < allCells.length; i++) {
      allCells[i].classList.remove('active-cell');
    }

    var activeCells = document.querySelectorAll("[data-cell-column=".concat(CSS.escape(column), "]"));
    ...
    for (var j = 0; j < activeCells.length; j++) {
      ...
      if (activeCells[j].getAttribute('data-on') === 'true') {
        ...
        if (activeCells[j].getAttribute('data-drum-sound') !== null) {
          var player = new tone__WEBPACK_IMPORTED_MODULE_0___default.a.Player("/files/".concat(activeCells[j].getAttribute('data-drum-sound'), ".wav")).toMaster();
          player.autostart = true;
          tone__WEBPACK_IMPORTED_MODULE_0___default.a.Buffer.on('load', function () {
            xplayer.start('0');
          });
        }
      }
...
function renderState() {
  ...
  state.sequencerState.forEach(function (synthColumn, i) {
    ...
    synthColumn.columnDataCells.forEach(function (synthCell, j) {
      var synthCellDom = document.createElement('div');
  ...
  state.bassState.forEach(function (bassColumn, i) {
    ...
    bassColumn.columnBassDataCells.forEach(function (bassCell, j) {
      var bassCellDom = document.createElement('div');
  ...
  var drumGrid = document.createElement('div');
  drumGrid.setAttribute('class', 'grid-wrapper');
  state.drumState.forEach(function (drumColumn, i) {
    ...
    drumColumn.columnDrumDataCells.forEach(function (drumCell, j) {
      var drumCellDom = document.createElement('div');
      var cellClasses = 'cell ';
...
//     {"portamento":0,"oscillator":{"type":"fatsawtooth","count":3,"spread":30},"envelope":{"attack":0.01,"decay":0.1,"sustain":0.5,"release":0.4,"attackCurve":"exponential"}},{"portamento":0,"oscillator":{"type":"sine"},"envelope":{"attack":0.001,"decay":0.1,"sustain":0.1,"release":1.2}}]
...
__webpack_require__(/*! /Users/magnusvaughan/side/composition-seven/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /Users/magnusvaughan/side/composition-seven/resources/js/custom.js */"./resources/js/custom.js");
module.exports = __webpack_require__(/*! /Users/magnusvaughan/side/composition-seven/resources/sass/app.scss */"./resources/sass/app.scss");
